...
const apiHost = 'https://hellocakeforyou.com/shop/client'
...
const hostGoodsList = (params) => wxRequest(params, apiHost + '/goods/hostGoodsList');
...
const getGoodsList = (params) => wxRequest(params, apiHost + '/goods/getGoodsListByCategoryDetail');
...
const goodsDetail = (params) => wxRequest(params, apiHost + '/goods/getGoodsById');
//商品加入购物车
...
const rootCtegoryList = (params) => wxRequest(params, apiHost + '/category/getCategoryList');
//二级三级分类
// getCategoryDetailList
//const childGoodsCatetoryList = (params) => wxRequest(params, apiMall + '/api/mall/childGoodsCatetoryList');
const childGoodsCatetoryList = (params) => wxRequest(params, apiHost + '/category/getCategoryDetailById');
//商品分类--end
...
//查询广告列表
const getCAdList = (params) => wxRequest(params, apiHost + '/adv/getAdvList');

const getMAdList = (params) => wxRequest(params, apiHost + '/adv/getAdvList');
const getMHomeDisvocerList = (params) => wxRequest(params, apiHost + '/goods/discoverList');
